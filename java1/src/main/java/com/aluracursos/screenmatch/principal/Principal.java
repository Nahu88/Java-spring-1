...
public class Principal {
    ...
    public void muestraElMenu(){
        ...
        //Convertir  todas las informaciones en una lista de tipo de episodios
        List<DatosEpisodio> datosEpisodios = temporadas.stream()
                .flatMap(t ->t.episodios().stream())
                .toList();

        //top 5 lista de episodios
//        datosEpisodios.stream()
//                .filter(e -> !e.evaluacion().equalsIgnoreCase("N/A"))
//                .peek(e -> System.out.println("Primer filtro"))
//                .sorted(Comparator.comparing(DatosEpisodio::evaluacion).reversed())
//                .peek(e -> System.out.println("Segundo filtro"))
//                .map(e->e.titulo().toUpperCase())
//                .peek(e -> System.out.println("Tercer filtro"))
//                .limit(4)
//                .forEach(System.out::println);

        //Convirtiendo los datos a una lista tipo episodios
...
//                                "fecha de lanzamiento de episodio" + e.getFechaLanzamiento()
//                ));

        //Buscar episodios por pedazo de titulo

//        System.out.println("Por favor escriba el titulo del episodio que quiera vear");
